...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=180pt,keepaspectratio]{kus_rf_exc_category}
    \includegraphics[width=180pt,keepaspectratio]{kus_svm_exc_category}
    \includegraphics[width=200pt,keepaspectratio]{kus_rf_exc_attack}
    \includegraphics[width=200pt,keepaspectratio]{kus_svm_exc_attack}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=180pt,keepaspectratio]{kus_rf_inc_category}
    \includegraphics[width=180pt,keepaspectratio]{kus_svm_inc_category}
    \includegraphics[width=200pt,keepaspectratio]{kus_rf_inc_attack}
    \includegraphics[width=200pt,keepaspectratio]{kus_svm_inc_attack}
