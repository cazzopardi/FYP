...
\begin{figure}[htbp]
    ...
    %     \centering
    %     \includegraphics[width=\textwidth,keepaspectratio]{DoS_roc}
    % \end{minipage}\hfill
    % \begin{minipage}[h]{0.5\textwidth}
    %     \centering
    ...
    % \begin{minipage}[h]{0.5\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth,keepaspectratio]{probe_roc}
    % \end{minipage}\hfill
    % \begin{minipage}[h]{0.5\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth,keepaspectratio]{knn_exc_category}
    ...
    % \begin{minipage}[h]{0.5\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth,keepaspectratio]{r2l_roc}
    % \end{minipage}\hfill
    % \begin{minipage}[h]{0.5\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth,keepaspectratio]{knn_exc_category}
    ...
    % \begin{minipage}[h]{0.5\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth,keepaspectratio]{u2r_roc}
    % \end{minipage}\hfill
    % \begin{minipage}[h]{0.5\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth,keepaspectratio]{knn_exc_category}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[h]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{kus_rf_exc_category_original}
    \end{minipage}\hfill
    \begin{minipage}[h]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{kus_svm_exc_category_original}
    \end{minipage}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[h]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{kus_rf_exc_attack_original}
    \end{minipage}\hfill
    \begin{minipage}[h]{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth,keepaspectratio]{kus_svm_exc_attack_original}
    \end{minipage}
