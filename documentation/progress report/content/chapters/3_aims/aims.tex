...
\begin{center}
    \fbox{\parbox{0.8\linewidth}{\textbf{Objective 1:} To determine the extent current state-of-the-art
...
\begin{center}
    \fbox{\parbox{0.8\linewidth}{\textbf{Objective 2:} To investigate the extent to which \gls{dl} is
            more or less effective in detecting unseen attacks than traditional \gls{ml}
            techniques.}}
\end{center}
